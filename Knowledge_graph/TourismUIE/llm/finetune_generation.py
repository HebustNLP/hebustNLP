...
def main():
    ...
    if data_args.dataset_name_or_path is None:
        ...
        train_ds, dev_ds = load_dataset(
            "json", data_files={"train": train_files, "validation": dev_files}, lazy=data_args.lazy
        )
    else:
        if data_args.task_name is not None:
            train_ds, dev_ds = load_dataset(
                data_args.dataset_name_or_path, data_args.task_name, splits=["train", "validation"]
            )
        else:
            train_ds, dev_ds = load_dataset(data_args.dataset_name_or_path, splits=["train", "validation"])
