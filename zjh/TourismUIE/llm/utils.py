...
def compute_metrics(eval_preds):
    ...
    # 计算精确度、召回率和F1分数
    precision = precision_score(y_true=filtered_labels, y_pred=filtered_preds, average='macro')
    recall = recall_score(y_true=filtered_labels, y_pred=filtered_preds, average='macro')
    f1 = f1_score(y_true=filtered_labels, y_pred=filtered_preds, average='macro')
