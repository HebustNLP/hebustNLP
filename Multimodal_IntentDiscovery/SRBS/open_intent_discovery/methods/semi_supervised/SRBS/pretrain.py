...
from utils.brb.brb_reclustering import soft_reset_only

class PretrainSRBSManager:
    ...
    def train(self, args, data):
        ...
        for epoch in trange(int(args.num_pretrain_epochs), desc="Epoch"):
            ...
            # 在 epoch 内部，加入条件 reset
            if epoch > 0 and epoch % args.soft_reset_interval == 0:
                self.model, self.optimizer = soft_reset_only(
                    module=self.model,
