...
def parse_arguments():
    ...
    parser.add_argument("--output_dir", default= '/root/autodl-tmp/baseline/CDACPlus', type=str, 
    ...
    parser.add_argument("--recalculate_centers", type=bool, default=False)
    parser.add_argument("--reset_momentum", type=bool, default=True)
    parser.add_argument("--reset_momentum_counts", type=bool, default=True)
    parser.add_argument("--reset_interpolation_factor", type=float, default=0.8)
    parser.add_argument("--reset_interpolation_factor_step", type=float, default=0.0)
    parser.add_argument("--reset_batchnorm", type=bool, default=False)
    parser.add_argument("--reset_embedding", type=bool, default=True)
    parser.add_argument("--reset_projector", type=bool, default=False)
    parser.add_argument("--reset_convlayers", type=bool, default=False)
    parser.add_argument("--reclustering_method", type=str, default="kmeans")
    parser.add_argument("--subsample_size", type=int, default=None)
    parser.add_argument("--soft_reset_interval", type=int, default=20)
