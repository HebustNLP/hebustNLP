...
class Param():
    ...
    def _get_hyper_parameters(self, args):
        ...
        """
        if args.multimodal_method == 'cabt':
            hyper_parameters = {
                ...
                'pretrain_temperature': [0.1],#0.1
                'train_temperature_sup': [7.5],     #7.5
                'train_temperature_unsup': [0.9],    #0.9
                'activation': 'tanh',
                'lr_pre': [5e-5],
                'lr': [3e-4],     
                'delta': [0.05],
                ...
                'attn_dropout': 0.1,
                'relu_dropout': [0.01],
                'embed_dropout': [0.05],#,0.1,0.05,0.01
                'res_dropout': 0.0,
                'attn_mask': True,
                'encoder_layers_1': 1,
                'fusion_act': 'tanh',
                'cross_num_heads': 8,
                'cross_dp_rate': [0.05],#0.1,
                'n_levels_cross': 2,
